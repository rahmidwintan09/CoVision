...
def about_page():
    ...
    with col1:
        st.image("https://raw.githubusercontent.com/rahmidwintan09/CoVision/212064132008d93a15a9c74e975bbd1e2977903f/images/matang.jpg", caption="Matang", use_container_width=True)
        st.markdown("""
        **Matang (Grade A)**  
        - Warna merah merata  
    ...
    with col2:
        st.image("https://raw.githubusercontent.com/rahmidwintan09/CoVision/212064132008d93a15a9c74e975bbd1e2977903f/images/setengah_matang.jpg", caption="Setengah Matang", use_container_width=True)
        st.markdown("""
    ...
    with col3:
        st.image("https://raw.githubusercontent.com/rahmidwintan09/CoVision/212064132008d93a15a9c74e975bbd1e2977903f/images/mentah.jpg", caption="Mentah", use_container_width=True)
        st.markdown("""
        **Mentah (Grade C)**  
        - Warna hijau 
        - Tekstur keras  
